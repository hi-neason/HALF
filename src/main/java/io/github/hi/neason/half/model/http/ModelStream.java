...
public class ModelStream implements Flow.Subscriber<String>, Flow.Subscription {
    private final Flow.Subscriber<? super ModelEvent> downstream;
    private final Consumer<ModelStream> starter;
    private final Consumer<ModelStream> release;
    ...
    public ModelStream(EventDecoder decoder, Flow.Subscriber<? super ModelEvent> downstream,
                 Consumer<ModelStream> starter, Consumer<ModelStream> release) {
    ...
    public void setExchange(CompletableFuture<?> value) {
        boolean stop;
        synchronized (lock) {
            exchange = value;
    ...
    public void setAlarm(ScheduledFuture<?> value) {
        boolean stop;
